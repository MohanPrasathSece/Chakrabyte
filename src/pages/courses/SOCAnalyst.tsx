    ...
    <div className="flex flex-col min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" className="relative bg-white text-purple-600 hover:bg-gray-100 font-bold px-4 sm:px-8 py-2 sm:py-3 text-base shadow-2xl hover:shadow-gray-500/25 hover:-translate-y-1 transition-all duration-300 rounded-2xl border-2 border-purple-300/50 group overflow-hidden">
              ...
              <Button asChild size="lg" variant="outline" className="relative bg-transparent backdrop-blur-md text-white hover:bg-white/10 font-bold px-4 sm:px-8 py-2 sm:py-3 text-base shadow-2xl hover:shadow-white/10 hover:-translate-y-1 transition-all duration-300 rounded-2xl border-2 border-white/50 group overflow-hidden">
                <Link to="/contact">
                  <span className="relative z-10 flex items-center gap-2">
                    Download Syllabus
                    <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
      ...
      <section className="py-24 bg-purple-600 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <Button asChild size="lg" className="bg-white text-purple-600 hover:bg-gray-100 font-semibold px-4 sm:px-6 py-2 sm:py-3 text-base">
            <Link to="/contact?course=soc-analyst">
              Enroll Now
            </Link>
          </Button>
