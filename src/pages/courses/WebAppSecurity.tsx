          ...
          <div className="max-w-4xl">
            <div className="mb-8">
              ...
              <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Web Application <span className="text-purple-200">Security</span>
              </h1>
              <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl">
                Master OWASP Top 10, API security, and secure coding practices to protect modern web applications professionally.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
                ...
                <div className="text-2xl font-bold mb-1">10 Weeks</div>
                <div className="text-sm opacity-80">Duration</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
                <Award className="w-8 h-8 mx-auto mb-3 text-purple-200" />
                <div className="text-2xl font-bold mb-1">12 Specialized</div>
                <div className="text-sm opacity-80">Modules</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
                <Users className="w-8 h-8 mx-auto mb-3 text-purple-200" />
                <div className="text-2xl font-bold mb-1">1100+ Trained</div>
                <div className="text-sm opacity-80">Students</div>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" className="bg-white hover:bg-gray-100 text-purple-900 font-semibold px-8 h-14 text-lg shadow-xl hover:shadow-2xl transition-all">
                <Link to="/contact?course=web-app-security">Enroll Now →</Link>
              </Button>
              <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-purple-900 font-semibold px-8 h-14 text-lg transition-all">
                Download Syllabus
              </Button>
            </div>
          </div>
      ...
      <section className="py-20 bg-purple-50">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4 text-purple-900">Course Overview</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-purple-200">
              ...
              <h3 className="font-heading text-xl font-bold mb-4 text-purple-900">What You'll Learn</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-purple-200">
              ...
              <h3 className="font-heading text-xl font-bold mb-4 text-purple-900">Who Should Enroll</h3>
              <ul className="space-y-3">
                {[
