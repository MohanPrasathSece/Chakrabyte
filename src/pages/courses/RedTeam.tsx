          ...
          <div className="max-w-4xl">
            <div className="mb-8">
              ...
              <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Red Team <span className="text-purple-200">Operations</span>
              </h1>
              <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl">
                Master advanced adversary simulation and offensive security techniques to assess organizational security posture.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
                ...
                <div className="text-2xl font-bold mb-1">14 Weeks</div>
                <div className="text-sm opacity-80">Duration</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
                <Award className="w-8 h-8 mx-auto mb-3 text-purple-200" />
                <div className="text-2xl font-bold mb-1">15 Advanced</div>
                <div className="text-sm opacity-80">Modules</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
                <Users className="w-8 h-8 mx-auto mb-3 text-purple-200" />
                <div className="text-2xl font-bold mb-1">500+ Trained</div>
                <div className="text-sm opacity-80">Students</div>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" className="bg-white hover:bg-gray-100 text-red-900 font-semibold px-8 h-14 text-lg shadow-xl hover:shadow-2xl transition-all">
                <Link to="/contact?course=red-team">Enroll Now →</Link>
              </Button>
              <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-red-900 font-semibold px-8 h-14 text-lg transition-all">
                Download Syllabus
              </Button>
            </div>
          </div>
